        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
          ...
          <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav mr-auto py-0">
              ...
              <a href="comprar.php" class="nav-item nav-link active">Comprar</a>
    ...
    function changeOptionFilterByCiudad() {
      ...
      productCards.forEach((card) => {
        if (selectValue != "Todas") {
          ...
          if (card.classList.contains(document.getElementById("filterByRegion").value)) {
            card.style.display = "block";
          }
        }
      });
            ...
            <div class="mt-3 mt-lg-4 ml-lg-3 text-center">
              ...
              <form method="post" action="inbuilding.php">
                <button type="submit" class="btn btn-warning mt-4 text-white">
                  <i class="icon-cart-add mr-2"></i> Comprar
                </button>
              </form>
            </div>
          </div>
